...
export default async function getSongs(
  search: string,
  searchEngine: SearchPlatform = 'pona! search',
  author: GuildMember,
  ...
  if (search.startsWith('https://pona.ponlponl123.com/share/')) {
    const playlistId = search.replace(
      'https://pona.ponlponl123.com/share/',
      '',
    );
    try {
