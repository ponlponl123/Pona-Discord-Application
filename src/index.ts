...
import { PonaDeliver as createBunAPIServer, PonaDeliver } from '@server/main-bun'
...
export const apiServer = runner === "bun" ? new PonaDeliver(expressConf.EXPRESS_PORT) : new createAPIServer(expressConf.EXPRESS_PORT);
